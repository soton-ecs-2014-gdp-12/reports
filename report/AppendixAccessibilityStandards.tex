...
\begin{longtable}{|L{0.6}|L{0.05}|L{0.26}|} 
...
\endlastfoot
\textbf{1.1 Text Alternatives:} Provide text alternatives for any non-text content so that it can be changed into other forms people need, such as large print, braille, speech, symbols or simpler language. &  & \eoline
\textbf{1.2 Time-based Media:} Provide alternatives for time-based media. & & \eoline
...
\textbf{1.4.1 Use of Color:} Color is not used as the only visual means of conveying information, indicating an action, prompting a response, or distinguishing a visual element. (Level A) &  & \eoline
