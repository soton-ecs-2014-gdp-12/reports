...
An appendix detailing the levels of accessibility standards compliance in the tools produced.
	\preamblequote{The power of the Web is in its universality. Access by everyone regardless of disability is an essential aspect.}{Tim Berners-Lee, Creator of World Wide Web}
\end{preamble}

\section{Introduction}

Both of the example user interfaces were tested against the \gls{WCAG} 2.0 Standards\footnote{\url{http://www.w3.org/TR/WCAG20/} (Accessed: 15 Jan 15)} to check for accessibility.
...
\hline \textbf{Standard} & \rot{\textbf{Pass }} & \textbf{Comment}\\ \hhline{|===|}
\endfirsthead
