...
\filldraw[fill=blue!40!white, draw=black] (0,0) rectangle (6,4) node[pos=.5] {Monitor};
\filldraw[fill=green!40!white, draw=black] (6,0) rectangle (12,4) node[pos=.5] {Keep Informed};
\filldraw[fill=red!40!white, draw=black] (0,4) rectangle (6,8) node[pos=.5] {Keep Satisfied};
\filldraw[fill=yellow!40!white, draw=black] (6,4) rectangle (12,8) node[pos=.5] {Manage Closely};
%labels      
