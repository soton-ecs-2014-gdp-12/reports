\chapter{Coding Conventions} \label{Chapter:Coding Conventions}

\chapterpreamble{How standards proliferate: \\ Situation: There are 14 competing standards \\ Researcher: 14?! Ridiculous! We need to develop one universal standard that covers everyone's use case! \\ Soon: \\ Situation: There are now 15 competing standards \\ - \small{XKCD - web comic}\footnote{XKCD Standards - \url{http://xkcd.com/927/}}}
