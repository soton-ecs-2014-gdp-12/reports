...
To create quality products an overall approach for the project were decided on. This was done by reviewing the previous work undertaken, getting specific requirements from the client and analysing the needs of the project stakeholders. This led to a list of requirements that the project would need to meet.

\section{Reviewing Previous Work}
Having reviewed the \href{Chapter:Previous Work}{previous work} some basic requirements for the project could be proposed to the client. 
...
The overlaid video player must be written in AngularJS and HTML5 to make it easily compatible with the new version of Synote. With this new requirement it was agreed that \gls{Videogular} should be used.
