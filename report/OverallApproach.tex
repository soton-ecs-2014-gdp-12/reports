...
\todo{The following paragraph needs reworking a bit}
...
\todo{Should this list be moved somewhere else}
\begin{itemize}
...
\todo{Do we need to make this diagram accessible and not use colour for the
components?}

\todo{The analytics frontend probably wants to link to the analytics server?}
