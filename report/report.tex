...
%From http://tex.stackexchange.com/questions/99310/fancy-chapter-title-page-for-entire-document
\titleformat{\chapter}[display]
  ...
  \raisebox{0.8in}{\parbox{.15\linewidth}{\large\rmseries\bfseries\chaptertitlename}}%
  \parbox[b]{.2\linewidth}{\chapternumberfont\thechapter}%
  }
  [\vspace*{1in}]

\titleformat{name=\chapter,numberless}[display]
  {\Huge\bfseries\rmfamily\color{white}}
