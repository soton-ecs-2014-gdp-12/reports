...
\newglossaryentry{DF}{name={Definition File}, text={Definition File},description={The definition file is used by vgQuestions plugin to create the overlaid quiz/poll}, plural={Definition Files}}
\newglossaryentry{vgQuestions}{text={Videogular Questions},name={Videogular Questions},description={A plugin to overlay quizzes and polls to videos},plural={Videogular Questions}}
...
\newacronym[description={Massive Open Online Course. A free study course available over the internet}]{MOOC}{MOOC}{Massive Open On-line Course}
