...
The example analytics site generally conformed to the WCAG 2.0 standards (see \autoref{Chapter:Accessibility Standards}). The non-conformances found were a lack of alternatives for the video and graphs.
